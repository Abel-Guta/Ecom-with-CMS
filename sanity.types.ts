...
export type AllSanitySchemaTypes = Sale | Order | Product | SanityImageCrop | SanityImageHotspot | Category | Slug | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
// Source: ./sanity/lib/sale/getActiveSaleById.ts
// Variable: ACTIVE_SALE_QUERY
// Query: *[_type == "sale" && couponCode == $couponCode && isActive == true][0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"product\" && references(*[_type==\"category\" && slug.current == $categorySlug]._id)] | order(name asc)": CATEGORY_PRODUCTS_QUERYResult;
    "*[_type == \"product\" && name match $searchParam ] | order(name asc)": PRODUCT_SEARCH_QUERYResult;
    "*[_type == \"sale\" && couponCode == $couponCode && isActive == true][0]": ACTIVE_SALE_QUERYResult;
  }
}
